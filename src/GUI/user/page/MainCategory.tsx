...
const MainCategory = () => {
    ...
    function goToMainCategoryWithQ2(qValue: string) {
                            ...
                            <div className="row g-4">
                                <div className="col-xl-3">
                                    <div className="input-group w-100 mx-auto d-flex">
                                        <input value={searchString2} onChange={handleSearch2} type="search" className="form-control p-3" placeholder="keywords"
                                            aria-describedby="search-icon-1" />
                                        <span onClick={goToMainCategoryWithQ2(searchString2)} id="search-icon-1" className="input-group-text p-3"><i className="fa fa-search"></i></span>
                                    </div>
                                </div>
