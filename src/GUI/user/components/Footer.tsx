                        ...
                        <div className="row g-4">
                            ...
                            <div className="col-lg-6">
                                <div className="position-relative mx-auto">
                                    ...
                                    <button type="submit" className="btn btn-primary border-0 py-3 px-4 position-absolute rounded-pill text-white" style={{ top: 0, right: 0 }}>
                                        Subscribe Now
                                    </button>
                                </div>
                            </div>
                    ...
                    <div className="row g-5">
                        ...
                        <div className="col-lg-3 col-md-6">
                            <div className="footer-item">
                                ...
                                <img src="assets/payment.png" className="img-fluid" alt="" />
                            </div>
                        </div>
                    </div>
                </div>
