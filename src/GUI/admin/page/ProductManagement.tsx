...
function ProductManagement() {
    ...
    const productTypeArray: ProductType[] = [ProductType.Vegetables, ProductType.Fruits, ProductType.Bread, ProductType.Meat];
    ...
    const colDefs: ColDef[] = [
        ...
        { headerName: "Image", field: "image", cellRenderer: ImageRenderer, width: 100 },
        {
            headerName: "Category",
            field: "category.name",
            editable: true,
        ...
        { headerName: "Price", field: "price", width: 100, valueFormatter: params => formatCurrency(params.value) },
        { headerName: "Sale Price", field: "salePrice", width: 130, valueFormatter: params => formatCurrency(params.value) },
        { headerName: "Quantity", field: "quantity", width: 100 },
        { headerName: "Rating", field: "ratings", width: 120, cellRenderer: RatingRender },
        { headerName: "Status", field: "productStatus", width: 100, cellRenderer: StatusCellRenderer },
        ...
        >
            <div className="d-flex justify-content-between align-items-center mb-3 mt-3">
                ...
                <div>
                    ...
                    <Button onClick={handleOpenCreateProductModal} variant="primary" style={{ marginLeft: "5px", fontWeight: 400 }}>
                        Create New Product
                    </Button>
