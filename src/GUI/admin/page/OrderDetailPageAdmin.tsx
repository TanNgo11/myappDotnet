...
function OrderDetailPageAdmin() {
    ...
    const [orderStatus, setOrderStatus] = useState<OrderStatus[]>([OrderStatus.CANCELED, OrderStatus.DELIVERED, OrderStatus.PENDING, OrderStatus.PAID, OrderStatus.RETURNED, OrderStatus.SHIPPING, OrderStatus.CONFIRMED]);
                        ...
                        <MDBCard style={{ borderRadius: "10px" }}>
                            <MDBCardHeader className="px-4 py-5 d-flex align-items-center ">
                                ...
                                <div className="col-md-6 ms-5">
                                    <div style={{ justifyContent: "end" }} className="d-flex align-items-center ">
                                        <label htmlFor="productStatus" className="form-label mb-0 me-2">Status</label>
                                        <select
